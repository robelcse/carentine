<link rel="stylesheet" id="sccss_style-css" href="assets/js/saved_resource" media="all">
    <link rel="stylesheet" id="theme_css-css" href="assets/css/style.min.css?<?php echo time(); ?>" media="all">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css">
    <link rel="icon" href="assets/images/favicon-16x16.png">
    <script type="text/javascript" src="assets/js/aam-login.js.download"></script>
    <script type="text/javascript" src="assets/js/jquery.js.download"></script>
    <script type="text/javascript" src="assets/js/ScrollMagic.min.js.download"></script>
    <script type="text/javascript" src="assets/js/jquery-migrate.min.js.download"></script>
